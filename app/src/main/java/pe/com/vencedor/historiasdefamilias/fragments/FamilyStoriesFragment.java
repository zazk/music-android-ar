 ...
 */
public class FamilyStoriesFragment extends Fragment {
    private View view;
    private Toolbar custom_toolbar;

    public static Fragment newInstance(){
        return new FamilyStoriesFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(pe.com.vencedor.historiasdefamilias.R.layout.fragment_family_stories,container,false);
        initToolbar(view);
        return view;
    }
    ...
    private void initToolbar(View view) {
        ...
        tvTitle.setText("Historias de Familias");
    }
}
