 ...
 */
public class TasaicoPlaying4Fragment extends Fragment {
    private View view;
    private ImageView ivVisor;
    private Toolbar custom_toolbar;

    public static Fragment newInstance(){
        return new TasaicoPlaying4Fragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tasaico_playing4,container,false);
        ivVisor = (ImageView)view.findViewById(R.id.ivVisor);

        ivVisor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment fragment = TasaicoPlaying5Fragment.newInstance();
