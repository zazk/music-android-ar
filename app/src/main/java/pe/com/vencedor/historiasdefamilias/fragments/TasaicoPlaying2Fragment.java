 ...
 */
public class TasaicoPlaying2Fragment extends Fragment {
    private View view;
    private ImageView ivVisor;
    private Toolbar custom_toolbar;

    public static Fragment newInstance(){
        return new TasaicoPlaying2Fragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(pe.com.vencedor.historiasdefamilias.R.layout.fragment_tasaico_playing2,container,false);
        ...
        ivVisor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment = TasaicoPlaying3Fragment.newInstance();
